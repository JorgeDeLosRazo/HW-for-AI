...
In 1ms, I2C can drain $$3.4~\text{(MBits/s)} \times 1~\text{ms} = 3400~\text{(bits)}$$, so there will be $$(5120 \times 1~\text{ms}) - 3400 = 1720~\text{bits}$$ left<br>

The size of the buffer then needs to be:
